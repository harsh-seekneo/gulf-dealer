    ...
    try {
      ...
      return {
        stats: {
          ...
          advertisementsUsed: dashboard?.stats?.advertisementsUsed ?? 0,
          advertisementPlacements: Array.isArray(dashboard?.stats?.advertisementPlacements)
            ? dashboard.stats.advertisementPlacements
            : [],
        },
        subscription: {
          _id: dashboard?.subscription?._id ?? null,
          planNameSnapshot: dashboard?.subscription?.planNameSnapshot ?? "",
          status: dashboard?.subscription?.status ?? "",
          startDate: dashboard?.subscription?.startDate ?? null,
          endDate: dashboard?.subscription?.endDate ?? null,
          amount: dashboard?.subscription?.amount ?? null,
          currency: dashboard?.subscription?.currency ?? "BHD",
        ...
        featuredDealer: {
          _id: dashboard?.featuredDealer?._id ?? null,
          planNameSnapshot:
            dashboard?.featuredDealer?.planNameSnapshot ?? "Featured Dealer",
          purchased: Boolean(dashboard?.featuredDealer?.purchased),
          active: Boolean(dashboard?.featuredDealer?.active),
          status: dashboard?.featuredDealer?.status ?? "NONE",
          startDate: dashboard?.featuredDealer?.startDate ?? null,
          endDate: dashboard?.featuredDealer?.endDate ?? null,
